  ...
  return (
    <div>
      <Typography variant="h5" gutterBottom>
        <span style={title}>Descargar documento</span>
      </Typography>
          ...
          <Grid item xs={6}>
            <TextField
              ...
              inputRef={register({
                ...
                minLength: {
                  value: 13,
                  message: "La longitud mínima debe ser igual a 13",
                },
                maxLength: {
                  value: 13,
                  message: "La longitud máxima debe ser igual a 13",
                },
              })}
              fullWidth
              type="text"
